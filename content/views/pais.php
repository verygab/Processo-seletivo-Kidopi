    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <p class="footer-text mb-2">Fonte dos dados: <a href="https://dev.kidopilabs.com.br/exercicio/covid.php?pais=<?php echo $pais ?>" target="_blank">Kidopi</a></p>
...
<script src="/content/assets/js/table.js"></script>
